...
object DzikirDoaData {
    ...
    val listDzikirPagi: ArrayList<DoaDzikirModel>
        get() {
            val list = arrayListOf<DoaDzikirModel>()
            for (data in descDzikirPagi.indices) {
                val dzikirDoa = DoaDzikirModel(
                    descDzikirPagi[data],
    ...
    val listDzikirPetang: ArrayList<DoaDzikirModel>
        get() {
            val list = arrayListOf<DoaDzikirModel>()
